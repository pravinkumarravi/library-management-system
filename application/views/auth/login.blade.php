                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            ...
                            @if($error)
                            <div class="mb-5 flex items-center gap-2 rounded-lg border border-error-200 bg-error-50 px-4 py-3 text-sm text-error-700 dark:border-error-500/20 dark:bg-error-500/10 dark:text-error-400">
                                <svg class="shrink-0 fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.401 3.003C10.556 1.01 13.444 1.01 14.599 3.003L22.848 17.248C24.007 19.246 22.554 21.75 20.249 21.75H3.751C1.446 21.75 -0.007 19.246 1.152 17.248L9.401 3.003ZM12 8.25C12.414 8.25 12.75 8.586 12.75 9V13.5C12.75 13.914 12.414 14.25 12 14.25C11.586 14.25 11.25 13.914 11.25 13.5V9C11.25 8.586 11.586 8.25 12 8.25ZM12 17.25C12.621 17.25 13.125 16.746 13.125 16.125C13.125 15.504 12.621 15 12 15C11.379 15 10.875 15.504 10.875 16.125C10.875 16.746 11.379 17.25 12 17.25Z" fill="currentColor" />
                                </svg>
                                {{ $error }}
                            </div>
                            @endif
                            ...
                            <form method="post" action="{{ $base_url }}auth/login">
                                <div class="space-y-5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ $base_url }}auth/forgot-password" class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <!-- Button -->
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href="{{ $base_url }}auth/signup" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign Up</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="{{ $base_url }}" class="mb-4 block">
