<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (mobile only) -->
            <a href="{{ $base_url }}dashboard" class="xl:hidden">
                <img class="dark:hidden" src="{{ $base_url }}assets/images/logo/logo.svg" alt="Logo" />
                <img class="hidden dark:block" src="{{ $base_url }}assets/images/logo/logo-dark.svg" alt="Logo" />
            </a>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="relative" x-data="{
                ...
                <div
                    ...
                    style="display: none;">
                    <div>
                        <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $auth_user['name'] ?? 'Administrator' }}</span>
                        <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ $auth_user['username'] ?? '' }}</span>
                    </div>
