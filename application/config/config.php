...
|
*/
$base_scheme = (isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) !== 'off') ? 'https' : 'http';
...
$config['base_url'] = $base_scheme . '://' . $base_host . $base_path . '/';
...
|	autoloading (application/config/autoload.php)
 |
| NOTE: This CodeIgniter fork resolves the path relative to APPPATH, so we
|       point it at the real vendor/autoload.php at the project root.
 */
